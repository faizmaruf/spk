                        ...
                        <div class="col-xl-9 col-lg-8">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">3. MENGHITUNG MATRIKS KEPUTUSAN
                                        TERNORMALISASI DAN
                                        TERBOBOT
                                    </h6>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="m-auto h-100 w-100 d-flex">
                                            <img src="<?= base_url() ?>assets/images/rumus/matriksterbobot.png" class="w-75 m-auto" alt="">
                                        </div>
                                    </div>
