                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start mt-5"
                        ...
                        <li class="nav-item mt-5">
                            <a href="<?= base_url() ?>home" class="nav-link align-middle px-0 text-light">
                        ...
                        <li class="nav-item mt-5">
                            <a href="<?= base_url() ?>data" class="nav-link px-0 align-middle text-light">
                                <i class="fs-4 bi-people"></i>
                                <span class="ms-1 d-none d-sm-inline">Data Pemain</span></a>
                        </li>
                        <!-- <li>
